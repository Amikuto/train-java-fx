...
public class TrainPost {
    ...
    public static void addNewTrain(LocalDate dateDep, LocalDate dateArr, LocalTime timeDep, LocalTime timeArr, String arrSt, String depSt, String depCity, String arrCity) throws IOException {
